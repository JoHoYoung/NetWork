...
void main()
{
	...
	::bind(listenSocket,(sockaddr*)&echoServerAddr,sizeof(echoServerAddr));
	...
	while( 1 )
	{
		...
		receiveSize=::recvfrom(listenSocket, echoBuffer, sizeof(echoBuffer), 0, (sockaddr*)&echoClientAddr, &clientAddrLen);
		if( receiveSize < 0 )
			continue;
		...
		::sendto(listenSocket,echoBuffer,255,0,(sockaddr*)&echoClientAddr,sizeof(echoClientAddr));
