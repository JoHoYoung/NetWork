...
void DoBlitExample(void)
{
	...
	if (dwBlitExamples == SHRINK_N_GROW)
	{
		...
		num++;
			...
			rcDest.left = (DWORD)(640 / 2 - 120 / 2-num);
			rcDest.top = (DWORD)(480 / 2 - 120 / 2-num);
			rcDest.right = (DWORD)(640 / 2 + 120 / 2+num);
			rcDest.bottom = (DWORD)(480 / 2 + 120 / 2+num);
				
		ddrval = lpDDSBack->Blt(&rcDest, lpDDSFace, NULL, NULL, NULL);
		//ddrval = Blt(&rcDest, lpDDSBack, NULL, NULL, NULL);
